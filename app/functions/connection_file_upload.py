...
from ..service.scr.check_installation import path, new_start
from ..service.scr.local_files_scr import firebase_project, file_path
...
def connection_file_error(page: ft.Page):
    ...
    if not new_start:
        connection_error.actions.append(
            ft.TextButton(
                text="Cancel",
                on_click=on_ok
            ),
